...
* **Initial Validation:** Identifying inconsistencies in dataset from the official Met Museum repository, data type errors, and structural issues across thousands of records.
